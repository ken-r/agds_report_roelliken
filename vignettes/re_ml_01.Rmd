...
At first, we need to add the predictions to the daily fluxes data set.
```{r}
...
```{r}
# margin in order to have enough space around individual plots
...
cowplot::plot_grid(gpp_obs, gpp_lm, res_lm, gpp_obs, gpp_knn, res_knn, 
...
k_vec <- c(seq(1, 5, by = 1), seq(8, 20, by = 2), seq(25, 50, 5), seq(100, 400, 100), 499)
