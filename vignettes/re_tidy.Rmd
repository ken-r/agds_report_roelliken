...
# decimal separator.
soil_organic_carbon <- read_delim("./../data/soil_organic_carbon_measurements.csv",
                                       delim = ";", 
                                       locale = locale(decimal_mark = "."),
                                       na = c("-")
                                       )
# Check if there were any problems.
problems(soil_organic_carbon)
```
...
soc_per_experiment <- soil_organic_carbon |>
  group_by(EXP) |>
  summarise(# How many samples for the whole experiment (both concentration
            # separately).
